...
import { Action, DotNetAddExistingProject, DotNetCreateProject, SlnAddProject } from '@actions';
...
export class AddNewProjectCommand extends SingleItemActionsCommand {
    ...
    public async getActions(item: TreeItem | undefined): Promise<Action[]> {
        ...
        const addAction = (item && item.contextValue === ContextValues.solution)
            ? new SlnAddProject(solution, projectPath)
