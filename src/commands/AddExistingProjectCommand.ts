...
import { Action, DotNetAddExistingProject, SlnAddProject } from "@actions";
...
export class AddExistingProjectCommand extends SingleItemActionsCommand {
    ...
    public async getActions(item: TreeItem | undefined): Promise<Action[]> {
        ...
        if (item.contextValue === ContextValues.solution) {
            return [ new SlnAddProject(solution, projectPath) ];
        }
