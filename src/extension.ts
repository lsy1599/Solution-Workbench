...
import { ensureMsBuildPathCached } from "@extensions/msvcDetector";
import { registerDebugListeners } from "@extensions/runTracker";
...
export function activate(context: vscode.ExtensionContext) {
    ...
    solutionFinder.setGlobalState(context.globalState);
    solutionFinder.setWorkspaceState(context.workspaceState);
    ...
    const solutionExplorerCommands = new SolutionExplorerCommands(context, solutionExplorerProvider, solutionFinder, actionsRunner, templateEngineCollection, eventAggregator);
    ...
    registerDebugListeners(context);
}
